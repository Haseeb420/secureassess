...
export default function EditQuestionPage() {
  ...
  if (!data) return <div className="p-6 text-red-400">Question not found.</div>

  return (
    <div className="p-6 max-w-3xl" data-color-mode="dark">
      <Link href="/dashboard/questions" className="mb-4 block text-xs text-zinc-500 hover:text-zinc-300">
        ← Questions
      </Link>
